...
@section('title', 'Dosen/Employee')

@section('content')
    <div class="rounded-4 p-5 mb-5 shadow-lg">
        <div class="d-flex justify-content-between">
            <div class="">
                <h2 class="text-dark m-0">Tambah Data Employee</h2>
            </div>
            <a href="/employee" class="btn btn-success btn-xs btn-flat"><i class="fa fa-pluscircle"></i>
                << Kembali </a>
        </div>
        <br>
